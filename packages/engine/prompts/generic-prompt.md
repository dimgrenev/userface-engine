...
4. **composition_validate** — Validate a face schema v1 JSON document structure. Checks nesting, contract compliance, $ref/$action resolution, pattern matching.
5. **ui_materialize** — Materialize a face schema v1 document into React JSX, Vue, or HTML code.
...
- **Face schema v1** — Declarative UI intermediate representation (framework-agnostic)
