...
function isRegistryVisibility(value) {
...
function readJsonFile(path, issuePath) {
    try {
...
function validatePackageName(manifestPackage, packageRoot, issues) {
...
function validateVisibility(value, issuePath, issues) {
...
function resolveComponentPath(value, issuePath, packageRoot, repoRoot, issues) {
...
export function loadRegistryManifest(manifestPath, options = {}) {
