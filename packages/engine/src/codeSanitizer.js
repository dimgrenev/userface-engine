...
export class UniversalCodeSanitizer {
    ...
    _jsxAttrsToPropsAndChildren(attrText) {
        ...
        while ((m = regex.exec(attrText)) !== null) {
            ...
            const strVal = (_a = m[3]) !== null && _a !== void 0 ? _a : m[4];
            const exprVal = m[5];
            if (exprVal !== undefined) {
                props[name] = { type: 'expr', value: exprVal };
            }
            else {
                props[name] = { type: 'str', value: strVal !== null && strVal !== void 0 ? strVal : '' };
            }
        }
